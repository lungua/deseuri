...
drop trigger miscariStocareUpdate ||
CREATE TRIGGER miscariStocareUpdate
AFTER Update ON miscaristocare 
FOR EACH ROW
...
BEGIN
   ...
   update  miscariluna    set miscStocare= miscStocare-wcantO+wcantN where idMiscariLuna=widMiscLuna;
