...
drop trigger cantValorificataUpdate ||
CREATE TRIGGER cantValorificataUpdate
AFTER Update ON cantvalorificata 
FOR EACH ROW
...
BEGIN
   ...
   update  miscariluna    set CantValorificate= CantValorificate-wcantO+wcantN where idMiscariLuna=widMiscLuna;
