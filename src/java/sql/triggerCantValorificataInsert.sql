...
drop trigger cantValorificataInsert ||
CREATE TRIGGER cantValorificataInsert
AFTER INSERT ON cantvalorificata
FOR EACH ROW
...
BEGIN
   ...
   update  miscariluna    set CantValorificate= CantValorificate+wcant where idMiscariLuna=widMiscLuna;
