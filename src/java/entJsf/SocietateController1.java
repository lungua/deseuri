...
@Named("societateController1")
@SessionScoped
public class SocietateController1 implements Serializable {
    ...
    @FacesConverter(forClass = Societate.class)
    public static class SocietateControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SocietateController1 controller = (SocietateController1) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "societateController1");
