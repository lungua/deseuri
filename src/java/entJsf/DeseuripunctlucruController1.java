...
@Named("deseuripunctlucruController1")
@SessionScoped
public class DeseuripunctlucruController1 implements Serializable {
    ...
    public DeseuripunctlucruController1() {
    }
    ...
    public static class DeseuripunctlucruControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            DeseuripunctlucruController1 controller = (DeseuripunctlucruController1) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "deseuripunctlucruController1");
